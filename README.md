...
Scripts and templates for Obsidian
...
* [makejournal.js](makejournal.js) - template generator used by Templater plugin (it sets frontmatter for JournalInfo)
* [Journal.md](Journal.md) - Templater template to be used with makejournal and JournalInfo
